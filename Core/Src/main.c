...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
uint8_t rxFlag;  //флаг о приеме данных
...
int main(void)
{
  ...
  while (1)
  {
	...
	proce_loop();
//HAL_GPIO_TogglePin(PWE_GPIO_Port, PWE_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS10_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS9_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS8_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS7_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS6_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS5_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS4_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS3_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS2_Pin);
//HAL_GPIO_TogglePin(CS10_GPIO_Port, CS1_Pin);
...
//			  data[7] =  (bufferRx[1] << 8) | (bufferRx[0] & 0xff);
//
//			  Thruster_Set_Perc(data); //записываем ширину импульса Ш�?Ма
//			  HAL_GPIO_TogglePin(LED_GPIO_Port, LED_Pin);
//			  HAL_UART_Receive_IT(&huart4, bufferRx, MAX_SIZE);
